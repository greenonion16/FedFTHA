...
def args_parser():
    ...
    parser.add_argument('--user_cat_list', type=list, default=[5], help="a list of user_cat_list")
    parser.add_argument('--cos', type=int, default=1, help="use cos loss")
    parser.add_argument('--novel_class_num', type=int, default=10, help="novel_class_num")
    parser.add_argument('--novel_users', type=int, default=10, help="novel_users")
    # parser.add_argument('--novel_epochs', type=int, default=5, help="novel_epochs")
    parser.add_argument('--finetune_epochs', type=int, default=10, help="novel_epochs")
    parser.add_argument('--collec_fea', type=int, default=0, help="collec_fea")
