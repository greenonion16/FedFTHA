...
from utils.train_utils import get_data, get_model, read_data, headavg
from utils.mini_imagenet import get_imagenet_data
from models.Update import LocalUpdate, LocalUpdateFTHA
from models.test import test_img_local_all, test_img, test_img_local
...
if __name__ == '__main__':
    ...
    global_rep_weights = []
    if args.alg == 'fedrep' or args.alg == 'fedper' or args.alg == 'fedftha':
    ...
    if args.alg == 'fedrep' or args.alg == 'fedper' or args.alg == 'lg' or args.alg == 'fedftha':
        num_param_glob = 0
        num_param_local = 0
    ...
    for iter in range(args.epochs + 1):
        ...
        for ind, idx in enumerate(idxs_users):
            ...
            if args.epochs == iter:
                ...
                elif args.alg == 'fedftha':
                    local = LocalUpdateFTHA(args=args, dataset=dataset_train, idxs=dict_users_train[idx])
                else:
            ...
            test_weight = copy.deepcopy(updated_net_local_weights)
            net_local.load_state_dict(test_weight)
            net_local.eval()
        ...
        if args.alg == 'fedrep' or args.alg == 'fedftha' or args.alg == 'fedper':
        ...
        if (iter + 1) % args.test_freq == 0:
            ...
            all_local_cor, all_local_loss = sum(acc_test_local) / tot, sum(loss_test_local) / tot
